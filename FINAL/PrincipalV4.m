        ...
        for j=1:M
            if (i==1)
              ...
              %  
                ...
                NoHO(i)=sum(handover);
                %NoHO(i)=mean(handover);
                PotPormedio(i)=mean(PotServidora);    
                IPromedio(i)=mean(I);
                SIRPromedio(i)=mean(SIR);
                x(i)=M1(MovilaMostrar,i).position_x;
                y(i)=M1(MovilaMostrar,i).position_y;
                ...
                %comet(x,y)
                    ...
                    if (handover(MovilaMostrar)==1)
                        HO = rsmak('circle',5,[M1(MovilaMostrar,i).position_x,M1(MovilaMostrar,i).position_y]);
